...
def run_ganancia_neta_mensual():
    ...
    ganancia_neta_mes = l.ganancia_neta_mensual(cantidad_kilometros, tarifa_kilometro, precio_galon, costo_mantenimiento)
...
def run_retorno_inversion():
    ...
    meses_retorno = l.retorno_inversion(cantidad_kilometros, tarifa_kilometro, precio_galon, costo_mantenimiento, precio_veiculo)
